        ...
        <main className="details-page">
            <form className="details-page-form" onSubmit={handleEditDetailsSubmit} >
                ...
                <div className="when">
                     ...
                     {!editDetailsBtn ? (
                          <div className="detail-text">
                               <p className="scroll">
                    {(new Date(listItem.listItemDate)).toLocaleDateString("en-US")}</p>
                </div>
             ) : (
             <input
                    type="date"
            ...
            <div id="container">
                <button className="edit-details-btn" onClick={() => setEditDetailsBtn(!editDetailsBtn)} >
                    <img className="edit-details-icon" src="https://i.imgur.com/uRSKxOT.png" alt="Edit" />
                </button>
                <Link to='/yourlist'>
                    <button className="delete-details-btn" onClick={() => deleteListItem(listItem._id)}>
                        <img className="delete-details-icon" src="https://i.imgur.com/wosDLot.png" alt="Delete" />
                    </button>
                </Link>
            </div>
        </main >
